...
/*   Updated: 2026/03/31 18:35:15 by ivmirand         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void) {
	...
	std::cout << "cat_1 idea[0]: " << cat_1.getBrain().getIdea(2) << std::endl;
	std::cout << "cat_2 idea[0]: " << cat_2.getBrain().getIdea(2) << std::endl;
	std::cout << std::endl;
