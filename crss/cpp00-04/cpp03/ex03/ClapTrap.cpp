...
/*   Updated: 2026/03/29 14:56:02 by ivmirand         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(void) :	m_name("Generic ClapTrap"),
							...
							m_energy_points(10),
							m_attack_damage(0) {
	std::cerr << m_name << "'s ClapTrap Default constructor called." << std::endl;
}
...
ClapTrap::ClapTrap(const std::string name) : m_name(name),
								...
								m_energy_points(10),
								m_attack_damage(0) {
	std::cerr << m_name << "'s ClapTrap Name constructor called." << std::endl;
}
...
ClapTrap::ClapTrap(const ClapTrap &src) : m_name(src.m_name),
	...
	std::cerr << m_name << "'s ClapTrap Copy constructor called." << std::endl;
}

ClapTrap::~ClapTrap(void) {
	std::cerr << m_name << "'s ClapTrap Destructor called." << std::endl;
}

ClapTrap& ClapTrap::operator=(const ClapTrap &src) {
	std::cerr << m_name << "'s ClapTrap Copy assignment operator called." << std::endl;
	m_name = src.m_name;
	m_hit_points = src.m_hit_points;
	m_energy_points = src.m_energy_points;
	m_attack_damage = src.m_attack_damage;
